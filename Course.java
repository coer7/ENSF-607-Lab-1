...
public class Course {
	...
	public String getAllSections() {
		...
		for (Offering offering : offeringList)
			st += offering.toString(false);    //I  need to have a toString in Offering
		return st;
	}
	public String getAllTakenCourses() {
		String st = "";
		//st += "\n";
		st += courseName + " " + courseNum;
	    st += "\n";
		for (Offering offering : offeringList)
			st += offering.toString(true);    //I  need to have a toString in Offering
		return st;
	}
	@Override
